...
import { savePhotoLocationAction } from '../actions';
...
export default async function PhotoPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ locationError?: string; locationSaved?: string }> }) {
