  ...
  return <main className="min-h-screen bg-[#f7f6f1] text-[#192326]">
    ...
    <div className="mx-auto max-w-4xl px-5 pb-18">
      ...
      <div className="space-y-16">{pages.map(page => {
        ...
        const details = [page.capturedAt?.toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' }), page.camera, page.lens, page.aperture, page.shutter, page.iso ? `ISO ${page.iso}` : null, page.focal].filter(Boolean);
