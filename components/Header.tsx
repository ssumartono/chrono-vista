...
export function Header() {
  ...
  return <header className="flex h-22 shrink-0 items-center justify-end gap-5 px-7 max-sm:h-17 max-sm:gap-3 max-sm:px-4">
    <form action="/archive" className="relative w-full max-w-86"><Search className="absolute left-3 top-1/2 -translate-y-1/2 text-[#536872]" size={19}/><input type="search" name="q" aria-label="Cari nama file foto" placeholder="Cari foto..." className="h-11 w-full rounded-md border border-[#d2d9d6] bg-white pl-10 pr-3 text-sm outline-none focus-visible:ring-2 focus-visible:ring-[#176f60]"/></form>
